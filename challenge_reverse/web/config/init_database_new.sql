...
INSERT INTO Products(Name, Description, Price, QuantityAvailable) VALUES ('Pirate flag', 'Dominate the seas and hacking challenges with this flag !<br /><i style="color: green">Note : This article is dematerialized, you can download it instantly after purchasing it</i>', 999.99, 1);
